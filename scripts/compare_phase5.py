"""Phase 5 comparison — pp_base vs pp_hs (main), pp_s (ablation)."""
...
VARIANTS = [
    ...
    ("pp_hs",   "acc_frz_pp_hs",  "outputs/phase5_online_11800711"),
    ("pp_s",    "acc_frz_pp_s",   "outputs/phase5_online_11800711"),
]
...
def main():
    ...
    for label, ck, online_dir in VARIANTS:
        ...
        results.append((label, ck,
                        l1(preds), l2(preds, test_records, TAUS),
    ...
    print("=" * 100)
    print(f"  {'variant':<10} {'ckpt':<20} {'MAE':>7} {'MSE':>7} {'bias':>8} {'ECE':>7} {'AUC':>6}  {'Q̂ min':>6} {'Q̂ max':>6} {'Q̂ med':>6}  {'std(Q̂)':>8} {'ratio':>6}")
    for label, ck, m1, _, _ in results:
        print(f"  {label:<10} {ck:<20} "
